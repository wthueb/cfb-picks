...
Run `pnpm db:seed` to migrate and populate the development SQLite database with three teams, six
users, and fourteen completed weeks of historical picks and results referencing those fixtures.
